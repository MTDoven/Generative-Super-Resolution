...
accelerate launch train.py \
  ...
  --dataset_metadata_path ./dataset/text_images/metadata_edit_full.csv \
  ...
  --fp8_models "black-forest-labs/FLUX.2-klein-base-4B:transformer/*.safetensors,black-forest-labs/FLUX.2-klein-base-4B:vae/diffusion_pytorch_model.safetensors,./models/Qwen/Qwen3.5-4B" \
